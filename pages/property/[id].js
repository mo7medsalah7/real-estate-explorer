    ...
    <>
      ...
      <div>
        <div className=" container mx-auto ">
          ...
          <div>
            <p className="mt-2 mb-4 text-gray-700 text-lg">{description}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div className="flex justify-evenly items-center">
              <span>Purpose: </span>
              <span className="font-bold text-lg capitalize ">{purpose}</span>
            </div>
            {furnishingStatus && (
              <div className="flex justify-evenly items-center">
          ...
          <div className="container mx-auto flex flex-col">
            {amenities.length && (
              <span className="text-lg font-bold mt-6 mb-4">Amenties: </span>
            )}
